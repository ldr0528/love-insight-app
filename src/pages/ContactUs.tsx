        ...
        <div className="bg-white rounded-3xl p-8 shadow-lg border border-blue-50 space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="text-gray-600 leading-relaxed space-y-4">
              <p>
                欢迎来到灵犀指引！这是一个致力于探索内心、连接缘分的小小宇宙。我们的初衷很简单：在这个快节奏的数字时代，为你提供一个温暖的角落，通过融合传统智慧与现代 AI 技术，帮助你更好地了解自己、理解他人。
              </p>
              <p>
                无论是通过 MBTI 探索人格潜能，还是在解忧杂货铺倾诉心事，亦或是通过 AI 恋爱军师寻找情感的答案，我们都希望这些小小的工具能为你带来一丝启发和治愈。
              </p>
            </div>
          </div>
